...
class ProductImageWithLoading extends StatefulWidget {
  final ProductModel product;

  const ProductImageWithLoading({super.key, required this.product});

  @override
  State<ProductImageWithLoading> createState() => _ProductImageWithLoadingState();
}

class _ProductImageWithLoadingState extends State<ProductImageWithLoading> {
